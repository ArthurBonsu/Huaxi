 ...
 * @returns {Web3|null} Web3 instance or null if no provider
 */
...
export const connectWallet = async () => {
  ...
  try {
    ...
    // Using any to work with ExternalProvider
 ...
 * @param {number} chainId - The blockchain network ID to switch to
